...
under-utilisation of shared-memory parallelism; and (5)~October and March produce
...
through pre/post comparisons, and extend the analysis to include I/O behaviour.
